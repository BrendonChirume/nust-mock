...
import DropdownMenu from '../globalCoponents/DropdownMenu'
...
export class SubNav extends Component {
    ...
    componentDidMount() {
        ...
        return window.innerWidth <= 576 ? this.setState({ isMobile: true }) : false;
    }
    ...
    render() {
        return (
            <div className="">
                {this.state.isMobile ?
                    <div className="d-flex subNav-search px-3 justify-content-between align-items-center position-relative">
                        <form className="position-relative">
                            <input disabled  type="search" name="naVsearch" id="naVsEArcH" className="nav-search border-0 rounded" placeholder="What do you want to learn?" />
                            <label htmlFor="naVsEArcH" className="center-itemY nav-search-label">
                    ...
                    : <div className="d-flex subNav-search px-3 justify-content-between align-items-center ">
                        <div className="search-container my-3">
                            <form className="position-relative w-100">
                                ...
                                <img src="data:image/svg+xml;base64," alt="" className="position-absolute search-icon center-itemY" />
                            </form>
                        </div>
                        <div className="d-flex submenu-activity">
                            ...
                            <div className="mx-1 py-2 rounded" onClick={this.submenuShow}>
                                <img src="data:image/svg+xml;base64," alt="" className="mx-4" />
                            </div>
                            <DropdownMenu active={this.state.submenuShow} array={this.state.submenuOptions} />
                        </div>
                    </div>}
            </div>
        )
